        ...
        <div class="accordion-item">
            <div id="ElementHeader{$ID}" class="accordion-header">
                <button
                    ...
                    aria-expanded="<% if $First && $Up.OwnerPage.OpenFirst %>true<% else %>false<% end_if %>"
            ...
            <div
                ...
                class="accordion-collapse collapse<% if $First && $Up.OwnerPage.OpenFirst %> show<% end_if %>"
                aria-labelledby="ElementHeader{$ID}"
                <% if not $Up.OwnerPage.KeepOpenned %>
